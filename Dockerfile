...
RUN apt-get update \
        && apt-get install -y build-essential autotools-dev autoconf automake unzip wget net-tools libtool flex bison gperf gawk m4 libssl-dev vim libreadline-dev openssl crudini \
        # Workaround for #663
