...
## Running your Virtuoso
    docker run --name virtuoso:ubuntu -p 8890:8890 -p 1111:1111 -e DBA_PASSWORD=dba -e SPARQL_UPDATE=true -v /home/nguyen/Workspace/virtuoso-docker/dataToLoad:/data 
