...
then
    ...
    virtuoso-t +wait && isql-v -U dba -P "$pwd" 

    #chmod +x /script/vload
    /script/vload /dataToLoad exportRecords.ttl http://data.alegoria-project.fr/id/ign/cartotheque/record/ /logs/vload.log dba
    /script/vload /dataToLoad exportInstantiations.ttl http://data.alegoria-project.fr/id/ign/cartotheque/record/ /logs/vload.log dba
    /script/vload /dataToLoad RefSpatialComplet.ttl http://data.alegoria-project.fr/id/ign/unitesadministratives/ /logs/vload.log dba
    /script/vload /dataToLoad CommunesWithinCartes.ttl http://data.alegoria.fr/id/geotheque/extrait/09122019/ /logs/vload.log dba
